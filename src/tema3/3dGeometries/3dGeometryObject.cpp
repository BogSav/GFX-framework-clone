...
BoundingBox GeometryObject3d::GetTranformedBBox(glm::mat4 modelMatrix)
{
	return m_bbox.GetTranformedBBox(modelMatrix);
}

BoundingBox GeometryObject3d::GetInitialBBox()
{
	return m_bbox;
}
