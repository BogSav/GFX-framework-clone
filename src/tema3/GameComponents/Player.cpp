...
{
	m_cube = std::make_unique<Polyhedron3d>(shader, camera, glm::vec3{-0.5f, -0.5f, -0.5f}, 1.f, 1.f, 1.f, Colors::Red);
	m_rightSki = std::make_unique<Polyhedron3d>(shader, camera, glm::vec3{-1.f, -0.05f, -0.15f}, 2.f, 0.3f, 0.1f, Colors::Cyan);
	m_leftSki = std::make_unique<Polyhedron3d>(shader, camera, glm::vec3{-1.f, -0.05f, -0.15f}, 2.f, 0.3f, 0.1f, Colors::Cyan);
...
void Player::Render()
{
	...
	m_modelMatrix = glm::translate(m_modelMatrix, m_field->m_currentPosition + glm::vec3{0, 0.5, 0.5});
