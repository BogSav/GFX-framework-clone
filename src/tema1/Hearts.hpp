...
private:
	...
	public:
		Heart(glm::vec3 v)
		{
			m_geometries.emplace_back(new Circle("stanga", 10, Colors::RED, 1.f, v + glm::vec3{ 1, 2, 0 }, 0.5f));
			m_geometries.emplace_back(new Circle("dreapta", 10, Colors::RED, 1.f, v + glm::vec3{ 2.7, 2, 0 }, 0.5f));
...
public:
	Hearts(TranformUtils::LogicSpace logicSpace, TranformUtils::ViewportSpace viewPortSpace, Shader* shader, const gfxc::Camera* camera)
		:
